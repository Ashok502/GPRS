! function(t) {
    t.fn.railsAutocomplete = function() {
        ...
        return void 0 !== t.fn.on ? t(document).on("focus", this.selector, e) : this.live("focus", e)
        ...
        init: function(e) {
            ...
            e.delimiter = t(e).attr("data-delimiter") || null, e.min_length = t(e).attr("min-length") || 2, e.append_to = t(e).attr("data-append-to") || null, e.autoFocus = t(e).attr("data-auto-focus") || !1, t(e).autocomplete({
                ...
                source: function(a, r) {
                    ...
                    t(e).attr("data-autocomplete-fields") && t.each(t.parseJSON(t(e).attr("data-autocomplete-fields")), function(e, a) {
                        ...
                        }), 0 == arguments[0].length && t.inArray(a.showNoMatches, [!0, "true"]) && (arguments[0] = [], arguments[0][0] = {
                            id: "",
